                ...
                <table class="custom-table1">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $feed->highlightRowForProcessorRequestId($feed->{'Ref Id'}) == 'highlight-green' ? 'highlight-green' : '' }}">
                            ...
                            <td>{{ $feed->{'Ref Id'} }}</td>
                            <td>{{ $feed->RRN }}</td>
                            <td><strong>₹ {{ number_format($feed->{'TRANSACTION AMOUNT'}, 0, '.', ',') }}</strong></td>
        ...
        <div class="row" style="font-size: 0.5rem;">
            <div class="col-md-6 m-0 p-0" style="border: 8px solid #2f84bc;">
                <div class="row ml-1">
                    ...
                    <div class="col diff-amount"> Total Diff Amount : <strong>₹ {{ number_format($diffInduslndAmount, 0, '.', ',') }}</strong></div>
                </div>
            </div>
            <div class="col-md-6 m-0 p-0" style="border: 8px solid #6b0aac;">
                <div class="row ml-1">
                    ...
                    <div class="col diff-amount"> Total Diff Amount : <strong>₹ {{ number_format($diffPaygInduslndAmount, 0, '.', ',') }}</strong></div>
                </div>
            </div>
        </div>
    </div>
